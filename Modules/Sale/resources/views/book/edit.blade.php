    ...
    <div class="card-body row">
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <select class="form-control select2bs4" name="customer" style="width: 100%;" disabled>
            <option value="{{ $current->customer_name }}">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" name="address" rows="3" placeholder="Masukkan alamat penjemputan">{{ $current->pickup_address }}</textarea>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <select class="form-control select2bs4" name="city_from" style="width: 100%;">
            ...
            <option value="{{ $cityItem->uuid }}" @selected($current->city_from == $cityItem->name)>
              {{ $cityItem->name }}
            </option>
            @endForeach
          </select>
        ...
        <div class="form-group">
          ...
          <select class="form-control select2bs4" name="city_to" style="width: 100%;">
            @foreach ($city as $cityItem)
            <option value="{{ $cityItem->uuid }}" @selected($current->city_to == $cityItem->name)>
              {{ $cityItem->name }}
            </option>
            @endForeach
          </select>
        ...
        <div class="form-group">
          <label>Catatan</label>
          <textarea class="form-control" name="notes" rows="3" placeholder="Masukkan catatan jika ada">{{ $current->notes }}</textarea>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <div id="busForm">
          @foreach ($bookbus as $bookbusItem)
            <div class="row">
              <div class="col-sm-6">
                <select class="form-control select2bs4" name="bus[]" style="width: 100%;">
                  @foreach ($bus as $busItem)
                      <option value="{{ $busItem->uuid }}" @selected($bookbusItem->bus_uuid == $busItem->uuid)>
              ...
              <div class="col-sm-4">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control moneyform busprice businput_1" name="busPrice[]" placeholder="Masukkan harga bus" value="{{ $bookbusItem->price }}" required>
                </div>
              </div>
              <div class="col-sm-2">
      ...
      <div class="col-sm-6">
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control moneyform" name="discount" placeholder="0" value="{{ $current->discount }}">
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            ...
            <div class="input-group-append">
              <span class="input-group-text">
              @if($current->tax == "0")         
                <input type="checkbox" name="hasTax" id="taxcheckbox">     
              @else
