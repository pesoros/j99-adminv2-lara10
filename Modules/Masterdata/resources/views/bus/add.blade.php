    ...
    <div class="card-body row">
      <div class="col-sm-12">
        ...
        <div class="form-group">
          ...
          <select class="form-control select2bs4" name="class_uuid" style="width: 100%;">
            @foreach ($class as $classItem)
                <option value="{{ $classItem->uuid }}" @selected(old('class_uuid') == $classItem->uuid)>
                    {{ $classItem->name }}
                </option>
            @endForeach
          </select>
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="email_bus" name="email_bus" placeholder="Masukkan email bus" value="{{ old('email_bus') }}">
        </div>
      </div>
    </div>
